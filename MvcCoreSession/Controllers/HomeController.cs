    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult EjemploSession(string accion) 
        {
            if (accion == "almacenar") 
            {
                ...
                persona.Nombre = "Almuno";
                persona.Edad = 22;
                persona.Hora = DateTime.Now.ToLongTimeString();
                //MEDIANTE EL HELPER CONVERTIMOS EL OBHJETO PERSONA A Stirng JSON
            ...
            else if (accion == "mostrar") 
            {
                ...
                Persona persona =HelperSession.DeserializeObject<Persona>(data);
        ...
        public IActionResult ColeccionSession(String accion) 
        {
            if (accion == "almacenar")
            {
                ...
                new Persona{ Nombre = "Andres", Edad = 39, Hora = DateTime.Now.ToLongTimeString()},
                new Persona{ Nombre = "Carlos", Edad = 41, Hora = DateTime.Now.ToLongTimeString()}
                };
                List<int> numeros =
